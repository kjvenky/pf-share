define([ 'jquery', 
	...
	"use strict"
	var ainventoryRefillRecordCollectionView = aBaseCollectionView.aBaseCollectionView.extend({
	...
	return {
		ainventoryRefillRecordCollectionView : ainventoryRefillRecordCollectionView
	}
})