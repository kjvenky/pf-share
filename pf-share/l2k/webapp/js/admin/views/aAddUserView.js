define(['jquery',
	'backbone',
	'underscore',
	'js/admin/forms/aAddUserForm'
	],function($,Backbone,_,aAddUserForm){

		"use strict"

		var aAddUserView = Backbone.View.extend({
			...
			render:function(){
				this.form = new aAddUserForm.aAddUserForm() // Render form on success
				return this
			}
