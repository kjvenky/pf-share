define([ 'jquery', 
	...
	"use strict"
	var acartoningCollectionView = aBaseCollectionView.aBaseCollectionView.extend({
		...
		events : {
			"click #cartonToDelivery":"cartonToDelivery",
			"click #completedDelivery":"completedDelivery"
		},
		completedDelivery:function(){
		$.ajax({
				url: contextUrl2 + "/admin/orders/process_orders/pushDeliveryReadyToCompleted	",
				type: "GET",
		...
		cartonToDelivery:function(){
			$.ajax({
				url: contextUrl2 + '/admin/orders/process_orders/pushCartoningToDeliveryReady',
				type: 'GET',
				success:function(data){					
					// Refresh the page
					Backbone.history.loadUrl();
	...
	return {
		acartoningCollectionView : acartoningCollectionView
	}
})